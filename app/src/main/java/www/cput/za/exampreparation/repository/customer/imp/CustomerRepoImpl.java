package www.cput.za.exampreparation.repository.customer.imp;
...
import www.cput.za.exampreparation.conf.DBConstants;
...
public class CustomerRepoImpl extends SQLiteOpenHelper implements CustomerRepo {
    ...
    public Set<Customer> findAll() {
        SQLiteDatabase db = this.getReadableDatabase();
        Set<Customer> personAddresses = new HashSet<>();
        try {
            open();
        } catch (SQLException e) {
            e.printStackTrace();
